    ...
    <section className="flex flex-col lg:grid-cols-12 lg:flex-row items-stretch justify-center px-6 py-16 space-y-6 lg:space-y-0 lg:space-x-10 xl:space-x-20">
      ...
      >
        ...
        <p className="text-md font-medium text-gray-700 leading-relaxed mb-6">
          At Vednath Ayurved, we are dedicated to preserving and promoting the
          ancient wisdom of Ayurveda, a holistic approach to health and wellness
        ...
        <div className="flex flex-row">
          ...
          <Image
            ...
            className="lg:hidden xs:hidden md:block lg:w-full md:mx-auto md:w-[48%] md:items-center lg:h-auto rounded-xl shadow-2xl object-cover 
                    hover:scale-105 transition-transform duration-300 hide-under-400"
          />
        </div>
      </motion.div>
      ...
      >
        ...
        />
        <p className="text-md font-medium text-gray-700 leading-relaxed mb-6">
          Our mission is to provide natural and effective Ayurvedic treatments
          and products to help you achieve optimal health and well-being.
        </p>
